...
USERNAME, PASSWORD = os.getenv("SAP_USERNAME"), os.getenv("SAP_PASSWORD")
AMBIENTE_SAP = os.getenv("SAP_AMBIENTE")
URL_BASE = os.getenv("SAP_URL")
...
class SAPTasaBCVClient:
    ...
    def __init__(
        ...
        self.endpoint_url = f"{URL_BASE}:{SAP_PORT}/fmcall/ZFI_TASA_BCV"
        self.username = username
        self.password = password
        self.sap_client = sap_client
        # caché interno: {"YYYYMMDD": [{"MONEDA": ..., "TASA": ..., ...}, ...]}
